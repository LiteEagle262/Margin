    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative" }}>
        <Stack spacing={4} sx={{ alignItems: "center", textAlign: "center" }}>
          ...
          >
            Drive your browser with an AI that{" "}
          ...
          <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 620, fontWeight: 400, lineHeight: 1.6 }}>
            Margin is a Chrome side-panel agent that reads live pages, clicks and types, captures network
            traffic, and keeps files in a local workspace — powered by a linked ChatGPT account or an
            OpenRouter API key.
          </Typography>
